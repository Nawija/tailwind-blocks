    ...
    <section class="text-gray-700 overflow-hidden">
        <div class="px-5 lg:px-12 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                <h2 class="sm:text-4xl text-3xl font-medium mb-2 text-gray-900">
                    Pricing
                </h2>
            ...
            <div class="flex flex-wrap -m-4">
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                        <small class="text-sm tracking-widest mb-1 font-medium uppercase">
                            Basic
                        </small>
                        ...
                        <button class="flex items-center mt-auto text-white bg-gray-700 border-0 py-2 px-4 w-full focus:outline-none hover:bg-black transition-colors rounded">
                            Button
                            <svg
                                fill="none"
                                stroke="currentColor"
