...
const B = () => (
    <section class="text-gray-800 overflow-hidden">
        <div class="px-5 lg:px-12 py-24 mx-auto">
            ...
            <div class="flex flex-wrap -m-4">
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                        <small class="text-sm tracking-widest title-font mb-1 font-medium uppercase">
                            Basic
                        </small>
                        <h2 class="text-4xl font-medium mt-1 text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">
                            Free
                        </h2>
                        ...
                        <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-black transition-colors rounded">
                            Button
                            <svg
                                fill="none"
                                stroke="currentColor"
                ...
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-amber-400 flex flex-col relative overflow-hidden">
                        <small class="bg-amber-400 animate-pulse text-white px-4 py-1 tracking-wide text-xs absolute right-0 top-0 rounded-bl font-bold">
                            POPULAR
                        </small>
                        <small class="text-sm tracking-widest title-font mb-1 font-medium">
                            PRO
                        </small>
                        <h2 class="text-4xl font-medium mt-1 text-gray-900 leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
                            <span>$300</span>
