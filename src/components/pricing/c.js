    ...
    <section class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            ...
            <div class="mb-6 grid gap-6 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 lg:gap-8">
                <div class="flex flex-col rounded-lg border p-4 pt-6">
                    <div class="mb-12">
                        ...
                        <p class="mx-auto mb-8 px-8 text-center text-gray-500">
                            For individuals and organizations who want to try
                            our system
                        </p>
                ...
                <div class="relative flex flex-col rounded-lg border-2 border-blue-600 p-4 pt-6">
                    <div class="mb-12">
                        <div class="absolute inset-x-0 -top-3 flex justify-center">
                            <span class="flex h-6 items-center justify-center rounded-full bg-blue-600 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-white">
                                most popular
                            </span>
                        </div>
